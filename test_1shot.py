...
import os
from function.function import ContrastiveLoss, seed_func, cal_accuracy_fewshot, cal_metrics_fewshot 
...
if args.dataset == 'CWRU':
    ...
    acc, f1, recall = cal_metrics_fewshot(test_dataloader_CWRU, net, device = args.device)
